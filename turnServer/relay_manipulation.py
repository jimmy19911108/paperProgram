...
class RelayManipulation():
    ...
    def relay_start(self):
        ...
        # if not receive data over 15 seconds, diconnect and delete client info
        dbm.DBManipulation().add_connect_client()
        self.udp_sock.settimeout(15)

        while True:
            try:
                self.udp_sock.sendto(self.udp_sock.recvfrom(2048)[0], self.remote_address)
