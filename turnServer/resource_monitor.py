...
class RsourceMonitor():
    ...
    def set_bandwidth(self):
        ...
        self.total_bandwidth = client.run().Mbps
    ...
    def get_mem_usage(self):
        ...
        return round((1 - mem.available/mem.total ) * 100, 4)
    ...
    def get_all_info(self):
        ...
        #return cpu_usage, bandwidth_usage, mem_usage
        return bandwidth_usage, mem_usage